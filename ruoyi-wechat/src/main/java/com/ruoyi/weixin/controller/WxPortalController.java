...
import com.ruoyi.weixin.config.WxMpConfiguration;
...
public class WxPortalController {
    ...
    public String post(@PathVariable String appid,
                       ...
                       @RequestParam(name = "msg_signature", required = false) String msgSignature) {        final WxMpService wxService = WxMpConfiguration.getMpServices().get(appid);        this.logger.info("\n接收微信请求：[openid=[{}], [signature=[{}], encType=[{}], msgSignature=[{}],"
