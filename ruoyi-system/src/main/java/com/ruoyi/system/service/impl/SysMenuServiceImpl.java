...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper,SysMenu> implements ISysMenuService
{
    ...
    public List<SysMenu> selectMenusByUser(SysUser user)
    {
        ...
        if (user.isAdmin())
        {
            ...
            queryWrapper.in("menu_type", Convert.toStrArray("M,C"));
    ...
    {
        return menuMapper.selectCount(new QueryWrapper<SysMenu>().eq("parent_id",parentId));
    }
    ...
    {
        return roleMenuMapper.selectCount(new QueryWrapper<SysRoleMenu>().eq("menu_id",menuId));
    }
    ...
    public String checkMenuNameUnique(SysMenu menu)
    {
        ...
        SysMenu info = menuMapper.selectOne(new QueryWrapper<SysMenu>().eq("menu_name",menu.getMenuName()).eq("parent_id",menu.getParentId()));
